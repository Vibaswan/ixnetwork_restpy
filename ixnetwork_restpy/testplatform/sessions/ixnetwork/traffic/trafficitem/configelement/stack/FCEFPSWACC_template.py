...
class FC_EFP_SW_ACC(Base):
    __slots__ = ()
    _SDM_NAME = 'FCEFPSWACC'
    _SDM_ATT_MAP = {
        'FC Header': 'fcEFPSWACC.header.fcHeader',
        'FC Command': 'fcEFPSWACC.header.fcCmd',
        'Reserved1': 'fcEFPSWACC.header.reserved1',
        'Reserved2': 'fcEFPSWACC.header.reserved2',
        'Payload Length': 'fcEFPSWACC.header.length',
        'Reserved3': 'fcEFPSWACC.header.reserved3',
        'Principal Switch_Priority': 'fcEFPSWACC.header.principalSwitchPriority',
        'Principal Switch_Name': 'fcEFPSWACC.header.principalSwitchName',
        'Record_Type': 'fcEFPSWACC.header.recordType',
        'Domain_ID': 'fcEFPSWACC.header.domainID',
        'Reserved4': 'fcEFPSWACC.header.reserved4',
        'Reserved5': 'fcEFPSWACC.header.reserved5',
        'Switch_Name': 'fcEFPSWACC.header.switchName',
    }

    def __init__(self, parent):
        super(FC_EFP_SW_ACC, self).__init__(parent)
