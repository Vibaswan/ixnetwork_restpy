...
class IS_IS_Level_2_LAN_Hello_PDU(Base):
    __slots__ = ()
    _SDM_NAME = 'isisLevel2LANHelloPDU'
    _SDM_ATT_MAP = {
        'Common header': 'isisLevel2LANHelloPDU.isisHeader.commonHeader',
        'Fixed header': 'isisLevel2LANHelloPDU.isisHeader.fixedHeader',
        'TLV header': 'isisLevel2LANHelloPDU.isisHeader.tlvHeader',
    }

    def __init__(self, parent):
        super(IS_IS_Level_2_LAN_Hello_PDU, self).__init__(parent)
