...
class LDP_Address_Withdraw_Message(Base):
    __slots__ = ()
    _SDM_NAME = 'ldpAddresWithdraw'
    _SDM_ATT_MAP = {
        'Version': 'ldpAddressWithdraw.header.version',
        'PDU length(in octets)': 'ldpAddressWithdraw.header.pduLengthinOctets',
        'LSR ID': 'ldpAddressWithdraw.header.lsrID',
        'Label space': 'ldpAddressWithdraw.header.labelSpace',
        'U bit': 'ldpAddressWithdraw.header.uBit',
        'Type': 'ldpAddressWithdraw.header.type',
        'Length': 'ldpAddressWithdraw.header.length',
        'Message ID': 'ldpAddressWithdraw.header.messageID',
        'FEC TLV': 'ldpAddressWithdraw.header.fecTLV',
        'Address list TLV': 'ldpAddressWithdraw.header.addressListTLV',
    }

    def __init__(self, parent):
        super(LDP_Address_Withdraw_Message, self).__init__(parent)
