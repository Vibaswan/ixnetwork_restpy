...
class FCoE_ESC_SW_RJT(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEESCSWRJT'
    _SDM_ATT_MAP = {
        'FCoE Header': 'fCoEESCSWRJT.header.fcoeHeader',
        'FC Header': 'fCoEESCSWRJT.header.fcHeader',
        'FC Command': 'fCoEESCSWRJT.header.fcCmd',
        'Reserved1': 'fCoEESCSWRJT.header.reserved1',
        'Reserved2': 'fCoEESCSWRJT.header.reserved2',
        'Reason Code': 'fCoEESCSWRJT.header.reasonCode',
        'Reason Code Explanation': 'fCoEESCSWRJT.header.reasonExplain',
        'Vendor Specific': 'fCoEESCSWRJT.header.vendor',
    }

    def __init__(self, parent):
        super(FCoE_ESC_SW_RJT, self).__init__(parent)
