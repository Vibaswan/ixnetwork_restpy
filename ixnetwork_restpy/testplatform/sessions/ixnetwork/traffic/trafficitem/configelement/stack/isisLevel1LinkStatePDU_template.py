...
class IS_IS_Level_1_Link_State_PDU(Base):
    __slots__ = ()
    _SDM_NAME = 'isisLevel1LinkStatePDU'
    _SDM_ATT_MAP = {
        'Common header': 'isisLevel1LinkStatePDU.isisHeader.commonHeader',
        'Fixed header': 'isisLevel1LinkStatePDU.isisHeader.fixedHeader',
        'TLV header': 'isisLevel1LinkStatePDU.isisHeader.tlvHeader',
    }

    def __init__(self, parent):
        super(IS_IS_Level_1_Link_State_PDU, self).__init__(parent)
