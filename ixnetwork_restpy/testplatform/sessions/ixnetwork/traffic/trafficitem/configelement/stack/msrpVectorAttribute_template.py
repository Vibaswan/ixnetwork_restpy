...
class MSRP_Vector_Attribute(Base):
    __slots__ = ()
    _SDM_NAME = 'msrpVectorAttribute'
    _SDM_ATT_MAP = {
        'Vector Header': 'msrpVectorAttribute.header.vectorHeader',
        'Select First Value Type': 'msrpVectorAttribute.header.selectFirstValueType',
    }

    def __init__(self, parent):
        super(MSRP_Vector_Attribute, self).__init__(parent)
