...
class FCoE_ELP_SW_RJT(Base):
    __slots__ = ()
    _SDM_NAME = 'fCoEELPSWRJT'
    _SDM_ATT_MAP = {
        'FCoE Header': 'fCoEELPSWRJT.header.fcoeHeader',
        'FC Header': 'fCoEELPSWRJT.header.fcHeader',
        'FC Command': 'fCoEELPSWRJT.header.fcCmd',
        'Reserved1': 'fCoEELPSWRJT.header.reserved1',
        'Reserved2': 'fCoEELPSWRJT.header.reserved2',
        'Reason Code': 'fCoEELPSWRJT.header.reasonCode',
        'Reason Code Explanation': 'fCoEELPSWRJT.header.reasonExplain',
        'Vendor Specific': 'fCoEELPSWRJT.header.vendor',
    }

    def __init__(self, parent):
        super(FCoE_ELP_SW_RJT, self).__init__(parent)
