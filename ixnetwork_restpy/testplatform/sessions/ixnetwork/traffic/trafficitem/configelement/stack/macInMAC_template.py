...
class MAC_in_MAC(Base):
    __slots__ = ()
    _SDM_NAME = 'macInMAC'
    _SDM_ATT_MAP = {
        'B-Destination Address (Ethernet)': 'macInMAC.header.bdestinationAddressEthernet',
        'B-Source Address (Ethernet)': 'macInMAC.header.bsourceAddressEthernet',
        'B-Ethernet Type': 'macInMAC.header.bethernetType',
        'I-Tag EtherType': 'macInMAC.header.itagEtherType',
        'I-Tag': 'macInMAC.header.itag',
        'C-Destination Address (Ethernet)': 'macInMAC.header.cdestinationAddressEthernet',
        'C-Source Address (Ethernet)': 'macInMAC.header.csourceAddressEthernet',
        'S-Tag': 'macInMAC.header.stag',
        'C-Tag': 'macInMAC.header.ctag',
        'Type': 'macInMAC.header.type',
    }

    def __init__(self, parent):
        super(MAC_in_MAC, self).__init__(parent)
