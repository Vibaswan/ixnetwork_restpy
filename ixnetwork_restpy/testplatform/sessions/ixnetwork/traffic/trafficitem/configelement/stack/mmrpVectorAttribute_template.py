...
class MMRP_Vector_Attribute(Base):
    __slots__ = ()
    _SDM_NAME = 'mmrpVectorAttribute'
    _SDM_ATT_MAP = {
        'Vector Header': 'mmrpVectorAttribute.header.vectorHeader',
        'Select First Value Type': 'mmrpVectorAttribute.header.selectFirstValueType',
    }

    def __init__(self, parent):
        super(MMRP_Vector_Attribute, self).__init__(parent)
