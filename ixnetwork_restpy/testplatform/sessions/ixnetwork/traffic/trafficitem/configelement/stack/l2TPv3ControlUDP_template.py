...
class L2TPv3_Control_Message_Over_UDP(Base):
    __slots__ = ()
    _SDM_NAME = 'l2TPv3ControlUDP'
    _SDM_ATT_MAP = {
        'L2TP Control Message Header': 'l2TPv3ControlUDP.header.controlHeader',
        'Message type Attribute-Value Pair': 'l2TPv3ControlUDP.header.messageTypeAvp',
        'Next AVP': 'l2TPv3ControlUDP.header.nextAvp',
    }

    def __init__(self, parent):
        super(L2TPv3_Control_Message_Over_UDP, self).__init__(parent)
