...
class eCPRI_Msg_Type_Bit_Sequence1(Base):
    __slots__ = ()
    _SDM_NAME = 'eCpriMsgType1'
    _SDM_ATT_MAP = {
        'pcid': 'eCpriMsgType1.header.pcid',
        'seqid': 'eCpriMsgType1.header.seqid',
        'userdata': 'eCpriMsgType1.header.header',
    }

    def __init__(self, parent):
        super(eCPRI_Msg_Type_Bit_Sequence1, self).__init__(parent)
