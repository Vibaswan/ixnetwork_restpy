...
class FC_RDI_SW_RJT(Base):
    __slots__ = ()
    _SDM_NAME = 'FCRDISWRJT'
    _SDM_ATT_MAP = {
        'FC Header': 'fcRDISWRJT.header.fcHeader',
        'FC Command': 'fcRDISWRJT.header.fcCmd',
        'Reserved1': 'fcRDISWRJT.header.reserved1',
        'Reserved2': 'fcRDISWRJT.header.reserved2',
        'Reason Code': 'fcRDISWRJT.header.reasonCode',
        'Reason Code Explanation': 'fcRDISWRJT.header.reasonExplain',
        'Vendor Specific': 'fcRDISWRJT.header.vendor',
    }

    def __init__(self, parent):
        super(FC_RDI_SW_RJT, self).__init__(parent)
